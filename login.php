...
$client->setClientId('830870764292-7vshap2psd50sdgpjmfa2m30qmtsq8kg.apps.googleusercontent.com');
// Enter your Client Secrect
$client->setClientSecret('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');
// Enter the Redirect URL
$client->setRedirectUri('http://localhost/quiz/login.php');
